...
RSpec.describe User, type: :model do
  ...
  describe "#words_count" do
    before do
      m2 = Message.create!( :user => @user ,:content => "test a 3432f258672__")
      Comment.create!( :user => @user, :message => m2, :content =>"a great tea" )
      Comment.create!( :user => @user, :message => m2, :content =>" 12345 + 88654 " )
    end
