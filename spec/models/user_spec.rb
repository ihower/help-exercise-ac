...
RSpec.describe User, type: :model do
  ...
  describe "#words_count" do
    before do
      ...
      m3 = Message.create!( :user => @user, :title=>"Ruby is good", :content=>"I like ruby"  )
      Comment.create!( :user => @user, :message => m3, :content=>"I aree" )
      Comment.create!( :user => @user, :message => m3, :content=>"cool" )
    end
