...
RSpec.describe User, type: :model do
  ...
  describe "#words_count" do
    before do
      ...
      mm1 = Message.create!( :user => @user, :title => "testtest", :content => "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo, quibusdam." )
      Comment.create!( :user => @user, :message => mm1, :content => "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo, quibusdam." )
    end

    it "加總該使用者的所有 Mesasge 和 Comment 的總字數" do
      # TODO: 測試 words_count 方法
        expect( @user.words_count ).to eq(21)
    end
  end
